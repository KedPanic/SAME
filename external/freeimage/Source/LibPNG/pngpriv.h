...
#ifndef PNG_IMPEXP
#  ifdef PNG_BUILD_DLL
#     define PNG_IMPEXP PNG_LIBRARY_EXPORT
#  else
...
/* pngconf.h does not set PNG_LIBRARY_EXPORT unless it is required, so: */
#ifndef PNG_LIBRARY_EXPORT
#  define PNG_LIBRARY_EXPORT
#endif
